...
# Use the imported DATABASES configuration
...
SECRET_KEY = 'django-insecure-vwilt(#2i+=jhfi)b*=ne33nqc2v)w2(0eqjd$7#isvk40pf2@'
...
#         'USER':'mahi',  # Database user

#         'PASSWORD':  'mahi123',  # Database password
